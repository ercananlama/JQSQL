...
JQSQL is .net library which is designed for MS SQL Server 2005 and higher versions to provide flexible and simple query options over JSON data.
...
To be able to use JQSQL with your MS SQL Server, you need to install it first. 
...
SampleDb.bak is a database backup which was created on MS SQL Server 2008 R2.
...
built: The output of the project which includes files used to install and run JSQL in MS SQL Server
